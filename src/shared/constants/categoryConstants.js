...
export const CATEGORIAS_OTROS_ARRAY = [
  ...
  CATEGORIAS_OTROS.TABLETS,
  CATEGORIAS_OTROS.AUDIO,
  CATEGORIAS_OTROS.CABLES_CARGADORES,
  // Fila 2: uso medio
  CATEGORIAS_OTROS.MONITORES,
  CATEGORIAS_OTROS.CAMARAS,
  CATEGORIAS_OTROS.CONSOLAS,
  CATEGORIAS_OTROS.GAMING,
  CATEGORIAS_OTROS.DESKTOP,
  CATEGORIAS_OTROS.DRONES,
  // Resto
  CATEGORIAS_OTROS.COMPONENTES,
  CATEGORIAS_OTROS.FUNDAS_TEMPLADOS,
  CATEGORIAS_OTROS.MOUSE_TECLADOS,
  CATEGORIAS_OTROS.ALMACENAMIENTO,
  CATEGORIAS_OTROS.PLACAS_VIDEO,
  CATEGORIAS_OTROS.STREAMING,
  CATEGORIAS_OTROS.REDES,
  CATEGORIAS_OTROS.BAGS_CASES,
  CATEGORIAS_OTROS.MEMORIA,
  CATEGORIAS_OTROS.REPUESTOS,
];
