      ...
      <div className="bg-white rounded overflow-hidden flex w-300 max-h-[80vh]">
        ...
        <div className="p-5 overflow-y-auto flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <h3 className="text-lg text-center font-semibold text-white bg-slate-800 px-3 py-2 rounded">Estado</h3>
              <div className="bg-slate-100 p-4 rounded-lg">
                <div><strong>Estado General:</strong> {producto.estado}</div>
                <div><strong>Batería:</strong> {producto.bateria}</div>
                <div><strong>Ciclos:</strong> {producto.ciclos}</div>
                <div><strong>Garantía Update:</strong> {producto.garantia_update || 'N/A'}</div>
                <div><strong>Garantía Oficial:</strong> {producto.garantia_oficial || 'N/A'}</div>
              </div>
            </div>
