          ...
          <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-3 top-2 text-slate-500 font-medium text-sm">U$</span>
                  <input type="number" name="precio_compra_usd" value={formData.precio_compra_usd} onChange={handleChange} step="0.01" placeholder="0.00" className="w-full pl-9 pr-3 py-2 border border-slate-200 rounded focus:outline-none focus:ring-2 focus:ring-slate-500 text-sm" required />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Costos Adicionales</label>
                <div className="relative">
                  <span className="absolute left-3 top-2 text-slate-500 font-medium text-sm">U$</span>
                  <input type="number" name="costos_adicionales" value={formData.costos_adicionales} onChange={handleChange} step="0.01" placeholder="0.00" className="w-full pl-9 pr-3 py-2 border border-slate-200 rounded focus:outline-none focus:ring-2 focus:ring-slate-500 text-sm" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Costo Total USD <span className="text-xs text-slate-500">(calculado)</span></label>
                <input type="text" value={`U$${((parseFloat(formData.precio_compra_usd) || 0) + (parseFloat(formData.costos_adicionales) || 0)).toFixed(2)}`} disabled className="w-full px-3 py-2 border border-slate-200 rounded bg-slate-50 text-slate-600 cursor-not-allowed text-sm" />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">Precio de Venta *</label>
                <div className="relative">
              ...
              <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <MarcaSelector value={formData.marca} onChange={(valor) => handleChange({ target: { name: 'marca', value: valor } })} placeholder="Seleccionar o agregar marca" className="w-full" />
                  </div>
                  <div>
