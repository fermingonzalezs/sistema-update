    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/50">
      <div className="bg-white rounded shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="bg-slate-800 text-white p-4 flex justify-between items-center rounded">
          ...
          <button onClick={onClose} className="p-1 rounded text-slate-400 hover:bg-slate-600 transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Footer con Botones */}
        <div className="bg-slate-50 p-4 flex justify-end gap-4 border-t border-slate-200 rounded">
          <button type="button" onClick={onClose} className="px-6 py-2 rounded bg-white border border-slate-200 text-slate-700 font-semibold hover:bg-slate-100 transition-colors">
            Cancelar
          </button>
