          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-orange-100 mt-1">Verificación física del inventario</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              {!recuentoIniciado ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full border border-gray-200 rounded-lg">
                <thead className="bg-orange-50">
                  <tr>
                    <th className="text-left py-3 px-4 font-medium text-orange-700">Producto</th>
                    <th className="text-center py-3 px-4 font-medium text-orange-700">Tipo</th>
