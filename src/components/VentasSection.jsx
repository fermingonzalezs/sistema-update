      ...
      {estadisticas && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 rounded-lg text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-100 text-sm">Ganancias</p>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nº Transacción</th>
                    ...
                    <tr className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`text-sm font-medium ${
                          transaccion.margen_total >= 0 ? 'text-green-600' : 'text-red-600'
                        }`}>
                            ...
                            <div className="grid gap-2">
                              {transaccion.venta_items?.map((item, index) => (
                                <div key={index} className="flex items-center justify-between bg-white p-3 rounded border">
                                  ...
                                  <div className="text-right">
                                    <div className="font-medium">{formatearMoneda(item.precio_total)}</div>
                                    <div className="text-sm text-gray-500">
