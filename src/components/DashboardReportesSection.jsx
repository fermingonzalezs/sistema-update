          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {formatearMoneda(ventasData.resumenGeneral.totalIngresos)}
                    </p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-4 rounded-lg text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-blue-100 text-sm">Margen Total</p>
                    <p className="text-2xl font-bold">
                      {formatearMoneda(ventasData.resumenGeneral.totalMargen)}
                    </p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-4 rounded-lg text-white">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {formatearMoneda(ventasData.resumenGeneral.ticketPromedio)}
                    </p>
                  </div>
              ...
              <div className="bg-gradient-to-r from-teal-500 to-teal-600 p-4 rounded-lg text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-teal-100 text-sm">Valor Inventario</p>
                    <p className="text-2xl font-bold">
                      {formatearMoneda(inventarioData.valorTotalInventario)}
                    </p>
                  </div>
