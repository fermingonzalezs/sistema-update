...
// Función para abrir recibo en navegador
export const abrirReciboPDF = async (transaccion) => {
  try {
    ...
    if (nuevaPestana) {
      console.log('✅ Recibo abierto en nueva pestaña');
      ...
      return { 
        ...
        filename: `recibo-${String(transaccion.numero_transaccion).padStart(6, '0')}-${new Date().toISOString().split('T')[0]}.pdf`
      };
    } else {
