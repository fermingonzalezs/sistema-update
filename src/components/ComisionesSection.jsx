    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 rounded-lg text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-purple-100 text-sm">% Representación</p>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">📱 Celulares</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">📦 Otros</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Total Ventas</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Total Ganancias</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Total Comisión</th>
                </tr>
              </thead>
                ...
                {comisionesCalculadas.map((vendedorData, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-green-600">
                      {formatearMoneda(vendedorData.totales.ganancias)}
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-xs text-gray-500">
                        {vendedorData.totales.ganancias > 0 
                          ? ((vendedorData.totales.comision / vendedorData.totales.ganancias) * 100).toFixed(1)
                          : 0}% de ganancia
                      </div>
                    </td>
                  </tr>
